"""Genshin Impact check-in and code redemption."""
...
REDEEM_URL = "https://sg-hk4e-api.hoyoverse.com/common/apicdkey/api/webExchangeCdkey"
CODE_SOURCE_URL = "https://api.ennead.cc/mihoyo/genshin/codes"
